    ...
    def __call__(self, model, data: Dict, mode: str):
        ...
        if mode == "train":
            if self.load and os.path.exists(os.path.join(self.poisoned_data_path, "train-poison.csv")):
                ...
                self.save_poison_data(poisoned_data["train-clean"], self.poison_data_basepath, "train-clean")
                self.save_poison_data(poisoned_data["train-poison"], self.poison_data_basepath, "train-poison")
                self.save_poison_data(poisoned_data["dev-clean"], self.poison_data_basepath, "dev-clean")
            ...
            if self.load and os.path.exists(os.path.join(self.poison_data_basepath, "test-poison.csv")):
                ...
                self.save_poison_data(poisoned_data["test-clean"], self.poison_data_basepath, "test-clean")
